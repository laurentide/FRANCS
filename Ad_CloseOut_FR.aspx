<div id="CO">
	<br>
	<center><span class="taille14 gras souligne">Fermeture</span></center>
	<br>
	<table cellpadding="3">
		<tr>
			<td>
				<span class="TitreFormulaire">Date de fermeture:</span>&nbsp;&nbsp;&nbsp;
		...
		<TR>
			<TD class="TitreFormulaire" colSpan="2">
				<asp:CheckBox id="HasProducedChange" runat="server" Text="Ce ARC a produit un changement"></asp:CheckBox></TD>
		</TR>
		<TR>
			<TD class="TitreFormulaire" colSpan="2">
		...
		<tr>
			<td class="TitreFormulaire" colspan="2">Message de fermeture:</td>
		</tr>
		<tr>
